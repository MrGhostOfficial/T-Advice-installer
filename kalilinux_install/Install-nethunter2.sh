...
cd /data/data/com.termux/files/home/T-Advice-installer/kalilinux_install;cp -rf kali-arm64 $HOME;rm -rf /data/data/com.termux/files/home/kalifs-arm64-full.sha512sum;rm -rf /data/data/com.termux/files/home/kalifs-arm64-full.tar.xz;rm -rf /data/data/com.termux/files/home/kalifs-arm64-minimal.sha512sum;rm -rf /data/data/com.termux/files/home/kalifs-arm64-minimal.tar.xz;rm -rf /data/data/com.termux/files/home/kalifs-arm64-nano.sha512sum;rm -rf /data/data/com.termux/files/home/kalifs-arm64-nano.tar.xz;cd /data/data/com.termux/files/home/kali-arm64/root;echo -e "" > .hushlogin;chmod +x .hushlogin;cp -rf /data/data/com.termux/files/home/T-Advice-installer/bash.bashrc $PREFIX/etc;cd $HOME